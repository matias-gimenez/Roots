<?
	...
	$query = "SELECT distinct id,nombre FROM proveedores  where fhbaja IS NULL  order by nombre";

	$sel_prov=mysqli_query ($con,$query) or die(mysqli_error($con));

	echo "<select name='n_cursos' id='i_proveedores' class='form-control' onchange=''> ";
