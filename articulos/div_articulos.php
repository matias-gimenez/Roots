<script src="articulos/articulos.js" type="text/javascript"></script>
...
$(document).ready(function(){
	...
	$("#id_confirm_baja").click(function(evento){
		...
		grabardatosarticulos("B");
	});

	// Cargar los datos para la busqueda
	$('#id_articulos_busq').load("articulos/busq_articulos.php");
...
<div id="div_articulos" class="center-block">
	...
	<div class="panel-heading clearfix">
		<div class="row">
			<div class="col-xs-10 col-sm-3">
				<h2 class="panel-title pull-left font-titulo-sector">Articulos</h2>
			</div>
			...
			<div class="col-xs-12 col-sm-8 col-sm-pull-1" id="id_articulos_busq"></div>
		</div>
	</div>

    <!--// Contenido del Panel //-->
	<div class="panel-body" id="id_articulos">
	</div>
