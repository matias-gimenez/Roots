...
$(document).ready(function(){
	...
	$("#id_confirm_baja").click(function(evento){
		...
		grabardatosusuarios("B");
	});

	// Cargar los datos para la busqueda
	$('#id_usuarios_busq').load("usuarios/busq_usuarios.php");
...
<div id="div_usuarios" class="center-block">
	...
	<div class="panel-heading clearfix">
		<div class="row">
			<div class="col-xs-10 col-sm-3">
				<h2 class="panel-title pull-left font-titulo-sector" >Usuarios</h2>
			</div>
			...
			<div class="col-xs-12 col-sm-8 col-sm-pull-1" id="id_usuarios_busq"></div>
		</div>
	</div>

    <!--// Contenido del Panel //-->
	<div class="panel-body" id="id_usuarios">
	</div>
